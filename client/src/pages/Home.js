    ...
    <div className='md:mx-28 mx-4 pt-10 pb-12'>
      ...
      <div className='md:grid md:grid-cols-2 items-center pt-4'>
        <div className='bg-white rounded-lg p-9'>
          ...
          <div className="flex flex-col space-y-4">
            ...
            <Link to="/posts">
              <button className='bg-tertiary hover:bg-white hover:text-black border-transparent border hover:border-tertiary  transition-all transition ease-in-out delay-400 py-2 px-8 rounded-md text-xl md:text-2xl text-white'>{t('homeCheckPost')}</button>
            </Link>

            <Link to="/exercise">
              <button className='bg-tertiary hover:bg-white hover:text-black border-transparent border hover:border-tertiary  transition-all transition ease-in-out delay-400 py-2 px-8 rounded-md text-xl md:text-2xl text-white'>{t('navLinkExercise')}</button>
            </Link>

          </div>

        </div>
        <div className="grid place-items-center drop-shadow-3xl p-3 shadow-black">
      ...
      <div className='md:grid md:grid-cols-2 pt-12 items-center'>
        <div className="grid place-items-center py-4 drop-shadow-3xl shadow-black">
          <img src={InspirationImg} alt="img" width="300" height="500" style={{ width: '400px' }} />
        </div>
        <div className='bg-tertiary text-white rounded-lg p-9'>

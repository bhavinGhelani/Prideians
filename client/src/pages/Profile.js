...
export default function Profile() {
  return (
    <div className='pt-8 pb-12 min-h-screen bg-white text-teritary rounded-lg' style={{ margin: '85px 100px' }}>
      <div className='mx-36 bg-white text-teritary rounded-lg'>
        <div className='grif place-items-center flex justify-center'>
        ...
        <div
          ...
          <div className="w-full md:w-2/3 flex flex-col p-3 justify-center">
